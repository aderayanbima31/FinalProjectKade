...
import com.kade.derayanbimaalamsyah.finalprojectkade.adapter.DetailTeamsAdapter
...
import com.kade.derayanbimaalamsyah.finalprojectkade.view.baseuianko.DetailTeamsUI
...
class DetailTeamsActivity : AppCompatActivity(), DetailTeamsView {
    ...
    private lateinit var mTeams: TeamModel
    private var mPlayer: MutableList<PlayerModel> = mutableListOf()
    ...
    override fun showEventList(data: List<TeamModel>, player: List<PlayerModel>) {
