...
import com.kade.derayanbimaalamsyah.finalprojectkade.view.baseuianko.DetailMatchesUI
...
class DetailMatchesActivity : AppCompatActivity(), DetailMatchesView {
    ...
    private lateinit var eventDetail: EventModel
    private lateinit var badgeHome: TeamModel
    private lateinit var badgeAway: TeamModel
    ...
    override fun showEventList(data: List<EventModel>, home: List<TeamModel>, away: List<TeamModel>) {
        eventDetail = data[0]
        badgeAway = away[0]
        badgeHome = home[0]
